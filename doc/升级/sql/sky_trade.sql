-- sky-trade 服务库：购物车、订单、订单明细
-- 来源：根目录 sky.sql 按域拆分
-- 说明：user_id / address_book_id / dish_id / setmeal_id 为跨服务逻辑外键，本库不建物理 FK

CREATE DATABASE IF NOT EXISTS `sky_trade` DEFAULT CHARACTER SET utf8mb4;
USE `sky_trade`;
