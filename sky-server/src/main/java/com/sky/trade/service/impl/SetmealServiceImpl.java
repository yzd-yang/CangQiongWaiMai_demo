...
import com.sky.trade.entity.SetmealDish;
import com.sky.trade.exception.DeletionNotAllowedException;
import com.sky.trade.exception.SetmealEnableFailedException;
import com.sky.trade.mapper.DishMapper;
import com.sky.trade.mapper.SetmealDishMapper;
import com.sky.trade.mapper.SetmealMapper;
import com.sky.trade.result.PageResult;
import com.sky.trade.service.SetmealService;
...
public class SetmealServiceImpl implements SetmealService {
    ...
    public void deleteBatch(List<Long> ids) {
        ...
        ids.forEach(setmealId->{
            //删除照片
            log.info("删除套餐图片：{}",setmealMapper.getById(setmealId).getImage());
            fileUploadUtil.delete(setmealMapper.getById(setmealId).getImage());
            //删除套餐
    ...
    public void update(SetmealDTO setmealDTO) {
        ...
        BeanUtils.copyProperties(setmealDTO,setmeal);
        //修改图片
        if(setmeal.getImage() !=setmealMapper.getById(setmealId).getImage()){
            fileUploadUtil.delete(setmealMapper.getById(setmealId).getImage());
            log.info("删除图片：{}",setmealMapper.getById(setmealId).getImage());
